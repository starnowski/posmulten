...
import com.github.starnowski.posmulten.configuration.yaml.jakarta.dao.SharedSchemaContextConfigurationYamlDao;
import com.github.starnowski.posmulten.configuration.yaml.jakarta.mappers.SharedSchemaContextConfigurationMapper;
import com.github.starnowski.posmulten.configuration.yaml.jakarta.model.*;

public class YamlConfigurationDefaultSharedSchemaContextBuilderFactory extends AbstractYamlConfigurationDefaultSharedSchemaContextBuilderFactory<PrimaryKeyDefinition, ForeignKeyConfiguration, TableEntry, StringWrapperWithNotBlankValue, RLSPolicy, CustomDefinitionEntry, ValidTenantValueConstraintConfiguration, SqlDefinitionsValidation, SharedSchemaContextConfiguration, SharedSchemaContextConfigurationYamlDao, SharedSchemaContextConfigurationMapper> {
    ...
    @Override
    protected SharedSchemaContextConfigurationMapper getSharedSchemaContextConfigurationMapper() {
        return mapper;
    }
}
