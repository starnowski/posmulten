...
public class RLSPolicyMapper extends AbstractRLSPolicyMapper<StringWrapperWithNotBlankValue, com.github.starnowski.posmulten.configuration.yaml.jakarta.model.PrimaryKeyDefinition, RLSPolicy> {
    ...
    @Override
    protected IConfigurationMapper<PrimaryKeyDefinition, com.github.starnowski.posmulten.configuration.yaml.jakarta.model.PrimaryKeyDefinition> getPrimaryKeyDefinitionMapper() {
