...
public interface AbstractRLSPolicy<T extends AbstractRLSPolicy, S extends AbstractStringWrapperWithNotBlankValue, PK extends AbstractPrimaryKeyDefinition> {
    ...
    T setTenantColumn(String tenantColumn);

    T setTenantColumn(S tenantColumn);
    ...
    T setValidTenantValueConstraintName(String validTenantValueConstraintName);

    T setValidTenantValueConstraintName(S validTenantValueConstraintName);
