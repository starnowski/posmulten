...
class RLSPolicyMapperTest extends AbstractConfigurationMapperTest<com.github.starnowski.posmulten.configuration.yaml.model.RLSPolicy, com.github.starnowski.posmulten.configuration.core.model.RLSPolicy, RLSPolicyMapper> {
    ...
    protected List<com.github.starnowski.posmulten.configuration.yaml.model.RLSPolicy> prepareExpectedMappedObjectsList() {
        [
                ...
                new com.github.starnowski.posmulten.configuration.yaml.model.RLSPolicy().setValidTenantValueConstraintName("constr_1").setValidTenantValueConstraintName(false),
                new com.github.starnowski.posmulten.configuration.yaml.model.RLSPolicy().setValidTenantValueConstraintName(true).setNameForFunctionThatChecksIfRecordExistsInTable("record_is_valid"),
    ...
    protected List<RLSPolicy> prepareExpectedUnmappeddObjectsList() {
        [
                ...
                new RLSPolicy().setValidTenantValueConstraintName("constr_1").setValidTenantValueConstraintName(false),
                new RLSPolicy().setValidTenantValueConstraintName(true).setNameForFunctionThatChecksIfRecordExistsInTable("record_is_valid"),
