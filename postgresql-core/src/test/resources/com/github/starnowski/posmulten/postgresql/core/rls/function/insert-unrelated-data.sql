...
-- users
INSERT INTO users (id, name, tenant_id) VALUES (1, 'Szymon Tarnowski', 'primary_tenant');
INSERT INTO users (id, name, tenant_id) VALUES (2, 'John Doe', 'secondary_tenant');
INSERT INTO users (id, name, tenant_id) VALUES (3, 'Jane Doe', 'primary_tenant');
