...
#Run test
pushd "$SCRIPT_DIR/.."
mvn -DskipTests clean install && mvn -pl :postgresql-core -Dspring.profiles.active=dev -P !unit-tests,integration-tests test && mvn -pl :postgresql-core-functional-tests -Dspring.profiles.active=dev -P !unit-tests,functional-tests test
popd
